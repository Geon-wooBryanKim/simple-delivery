...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    /*jwt token을 받기 전에 fcm토큰이 먼저 생성되어 onNewToken함수가 콜백되었을 때 jwtToken값이 비어있어서
    updateFcmToken요청을 보냈을 때 헤더에 jwt token이 없기 때문에 제대로 동작하지 않을거라고 예상됨.*/
    @Override
